...
//Settings
const maxWaitTime = 8000; //milliseconds
const minWaitTime = 2000;  //milliseconds
var maxFailures = 10;
//End settings
...
(function loop() {
  ...
  var randomEmail = function () {
    ...
    var randomChar = faker.random.alphaNumeric();
    if (Math.floor(Math.random() * 10) % 2 === 0) {
      fullName = lastName + union + firstName + randomChar;
    } else {
      fullName = randomChar + firstName + union + lastName;
    }
  ...
  var voteForGuido = function () {
    ...
    request(options, function (error, response, body) {
      ...
      if (body && !body.success) {
        ...
        maxFailures--;
        if (maxFailures <= 0) {
          console.log("Stopping because of repeated errors!");
          process.exit();
        }
        console.log("<<<< Will halt script in " + maxFailures + " more failures >>>>");
      }
    });
  }
